...
async function openModal(id) {
  ...
  document.getElementById('modalProductoBody').innerHTML = `
    ...
    <div class="form-group">
      ...
      <div class="d-grid gap-3 p-3 radius-md" id="pDisenosWrap" style="background:var(--color-fog);grid-template-columns:repeat(auto-fill,minmax(90px,1fr));max-height:320px;overflow-y:auto;">
        <p class="text-xs text-muted">Cargando diseños…</p>
      </div>
    </div>
    <div class="form-group">
